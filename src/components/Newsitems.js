  ...
  render() {
    ...
    return (
      <div className="card" >
        ...
        <img style={{height: "250px"}} src={!imageurl ? "https://cdn.hipwallpaper.com/i/69/50/rUFRE3.jpg" : imageurl} className="card-img-top"  alt="..."  />
        ...
        <span className="badge rounded-pill bg-danger" id="publisher">{name}
          ...
          <p className="card-text"><small className="text-muted">By {!author?name:author.substr(0,20)} on  {new Date(publishedAt).toUTCString()}</small></p>
